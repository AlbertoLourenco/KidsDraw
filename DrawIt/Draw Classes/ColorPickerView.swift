...
//  DrawIt
//
//  Created by Alberto Lourenço on 4/11/20.
...
class ColorPickerView : UIView {
    ...
    private var rect_grayPalette = CGRect.zero
    private var rect_mainPalette = CGRect.zero
    ...
    override func draw(_ rect: CGRect) {
        ...
        rect_mainPalette = CGRect(x: 0, y: rect_grayPalette.maxY, width: rect.width, height: rect.height - rect_grayPalette.height)
